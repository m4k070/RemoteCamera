...
Java_com_interlinkj_android_remotecamera_RemoteCamera_yuv420sp2rgb(JNIEnv * env, jobject obj,
		jintArray rgb, jbyteArray yuv420sp, jint width, jint height, jint type)
{
    void *in, *out;
    int psz = getpagesize();
    int header_size;
